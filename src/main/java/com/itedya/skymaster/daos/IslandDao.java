...
import com.itedya.skymaster.deserializers.IslandDtoDeserializer;
import com.itedya.skymaster.dtos.IslandDto;
import com.itedya.skymaster.serializers.IslandDtoSerializer;
...
public class IslandDao {
    ...
    private IslandDao() throws IOException {
        ...
        String path = Paths.get(plugin.getDataFolder().getAbsolutePath(), "data", "islands.json").toString();
