...
public class VisitBlockDaoSqulUnit {
    ...
    public static final String REMOVE = "UPDATE `skymaster_visit_blocks` SET deletedAt = CURRENT_TIMESTAMP WHERE islandOwnerUuid = ? AND blockedPlayerUuid = ? AND deletedAt IS NULL";
}
